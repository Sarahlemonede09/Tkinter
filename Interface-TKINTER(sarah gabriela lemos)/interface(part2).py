...
checkbox_politicas= tk.Checkbutton(text='Aceito os termso de Uso e Políticas de Privacidade', variable=var_politicas)
...
def enviar():
    ...
    if var_politicas.get():
        print('Usuário concorda com Termos de Uso e Políticas de Privacidade')
    else:
        print('O usuário NÃO concorda')
